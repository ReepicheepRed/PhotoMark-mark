...
import me.jessyan.mvparms.demo.app.App;
import me.jessyan.mvparms.demo.app.utils.util.Point2D;
import me.jessyan.mvparms.demo.app.utils.util.UIUtils;
import me.jessyan.mvparms.demo.mvp.ui.widget.drawable.EditableDrawable;
import me.jessyan.mvparms.demo.mvp.ui.widget.drawable.FeatherDrawable;
...
public class MyHighlightView implements EditableDrawable.OnSizeChange {
    ...
    public void setScaleable(boolean scaleable) {
        ...
        if (scaleable) {
            mAnchorRotate = App.getApp().getResources().getDrawable(R.mipmap.ic_roteteded_tb);
        } else {
            mAnchorRotate = null;
        }
    }
    ...
    public void setDeleteable(boolean deleteable) {
        if (deleteable) {
            mAnchorDelete = App.getApp().getResources().getDrawable(R.mipmap.ic_tan_close);
        } else {
            mAnchorDelete = null;
        }
    }
    ...
    public MyHighlightView(ImageView context, int styleId, FeatherDrawable content) {
        ...
        mAnchorRotate = App.getApp().getResources().getDrawable(R.mipmap.ic_roteteded_tb);
        mAnchorDelete = App.getApp().getResources().getDrawable(R.mipmap.ic_tan_close);
        mAnchorEdit = App.getApp().getResources().getDrawable(R.mipmap.ic_edit_tb);
