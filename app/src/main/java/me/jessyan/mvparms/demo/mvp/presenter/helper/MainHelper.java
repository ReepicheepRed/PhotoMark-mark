package me.jessyan.mvparms.demo.mvp.presenter.helper;
...
//    private PhotoAdapter photoAdapter;
    ...
    public void init(View btn,Activity mActivity){
        mContext = mActivity;
        ...
        galleryConfig = new GalleryConfig.Builder()
                ...
                .multiSelect(true,100)                   // 配置是否多选的同时 配置多选数量   默认：false ， 9
                .maxSize(100)                             // 配置多选时 的多选数量。    默认：9
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                galleryConfig.getBuilder().maxSize(100).isOpenCamera(false).build();
                initPermissions();
            }
        });
    }
